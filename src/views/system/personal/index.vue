          ...
          <div class="personal-user">
            <div class="personal-user-left">
              <el-upload class=" h100 personal-user-left-upload avatar-uploader"
                :action="baseURL + '/api/v1/system/upload/singleImg'" :show-file-list="false"
                :on-success="handleAvatarSuccess" :data="dataParam">
...
import { getToken } from "@/utils/thinkvue3"
...
const { personalForm, imageUrl, deptName, roles } = toRefs(state)
</script>
