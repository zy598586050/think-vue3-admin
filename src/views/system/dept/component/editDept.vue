		...
		<el-dialog :title="(ruleForm.deptId !== 0 ? '修改' : '添加') + '部门'" v-model="isShowDialog" width="769px">
				...
				<el-row :gutter="35">
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="上级部门">
							<el-cascader :options="deptData"
								...
								placeholder="请选择部门" clearable class="w100" v-model="ruleForm.parentId">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="部门状态">
							<el-switch v-model="ruleForm.status" :active-value="1" :inactive-value="0" inline-prompt
			...
			<template #footer>
				<span class="dialog-footer">
					...
					<el-button type="primary" @click="onSubmit" size="default">{{ ruleForm.deptId !== 0 ? '修 改' : '添加'}}</el-button>
				</span>
			</template>
		</el-dialog>
	</div>
...
const { ruleForm, isShowDialog, deptData, rules } = toRefs(state)
