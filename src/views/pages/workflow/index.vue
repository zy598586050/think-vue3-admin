...
import { toRefs, reactive, computed, onMounted, onUnmounted, nextTick, ref } from 'vue';
...
const { isShow, jsplumbData, jsPlumbNodeIndex, dropdownNode, dropdownLine } = toRefs(state)
</script>
