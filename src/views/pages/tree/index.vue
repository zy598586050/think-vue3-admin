	...
	<div class="tree-container">
		<el-card shadow="hover" header="element plus Tree 树形控件改成表格">
			<div v-loading="treeLoading">
				<div class="tree-head">
					<div class="tree-head-check"><el-checkbox v-model="treeCheckAll"
							@change="onCheckAllChange"></el-checkbox></div>
				...
				<el-tree :data="treeTableData" show-checkbox node-key="id" ref="treeTable" :props="treeDefaultProps"
					@check="onCheckTree">
...
const { treeLoading, treeCheckAll, treeDefaultProps, treeTableData } = toRefs(state)
</script>
