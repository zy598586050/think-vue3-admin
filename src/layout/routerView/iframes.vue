<template>
	<div class="layout-view-bg-white flex mt1" :style="{ height: `calc(100vh - ${setIframeHeight}`, border: 'none' }"
		...
		<iframe :src="iframeUrl" frameborder="0" height="100%" width="100%" ref="iframeDom"
			v-show="!iframeLoading"></iframe>
	</div>
</template>

<script setup lang="ts">
import { reactive, toRefs, onMounted, nextTick, watch, computed } from 'vue';
...
const { iframeLoading, iframeUrl } = toRefs(state)
</script>
