		...
		<el-drawer :title="$t('message.layout.configTitle')" v-model="getThemeConfig.isDrawer" direction="rtl"
			...
			<el-scrollbar class="layout-breadcrumb-seting-bar">
				...
				<div class="layout-breadcrumb-seting-bar-flex mt14">
					<div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('message.layout.twoIsMenuBarColorGradual') }}
					</div>
					<div class="layout-breadcrumb-seting-bar-flex-value">
				...
				<div class="layout-breadcrumb-seting-bar-flex mt15" :style="{ opacity: isMobile ? 0.5 : 1 }">
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-switch v-model="getThemeConfig.isSortableTagsView" :disabled="isMobile ? true : false"
...
import { nextTick, onUnmounted, onMounted, getCurrentInstance, computed, reactive, toRefs } from 'vue';
